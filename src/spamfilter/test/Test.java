...
public class Test {
    ...
    public void test() throws FileNotFoundException, IOException {
        ...
        // load test data
        File spamDirectory = new File("data/test/spam");
        File[] spamFiles = spamDirectory.listFiles();
        int totalSpam = spamFiles.length;

        File hamDirectory = new File("data/test/ham"); 
        ...
        this.printReport(totalHam, totalSpam, totalClassifiedAsHam, totalClassifiedAsSpam);
    }
     ...
     */
    public void printReport(int totalHam, int totalSpam, int totalClassifiedAsHam, int totalClassifiedAsSpam) {		
